@extends('layouts.app')
@section('title')
<title>Codedigger Upsolve Rated Contest Problems</title>
@endsection
      ...
      <div class="row justify-content-center">
            ...
            <div class="card card-1 boxed boxed--sm ">
                ...
                <div class="card__body">
                    @if($sortBy == "rating")
                    <a class="btn btn--sm" href="{{route('upsolve.index')}}?sortBy=latest">
                        <span class="btn__text">Latest Contest</span>
                    </a>
                    @else
                    <a class="btn btn--sm" href="{{route('upsolve.index')}}?sortBy=rating">
