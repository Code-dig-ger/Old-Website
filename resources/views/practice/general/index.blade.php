@extends('layouts.app')
@section('title')
<title>Codedigger Level wise Competitive Programming Practice</title>
@endsection
    ...
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8">
                <div class="wrapper"><h1 style="font-family: 'Lobster', sans-serif; margin-bottom:0; font-size:4rem;">Levelwise Practice</h1></div>
            </div>
            @if(!auth()->user())
            <p class = "imagebg">
                ...
                @foreach ($topics as $item)
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <a class="btn btn--sm" href="{{route('practice.general.show' ,$item->id)}}">
