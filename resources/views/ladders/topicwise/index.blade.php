...
@section('title')
<title>Codedigger Topic wise Ladders Index</title>
@endsection
    ...
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8">
                <div class="wrapper"><h1 style="font-family: 'Lobster', sans-serif; margin-bottom:0; font-size:4rem;" >Topicwise Ladder</h1></div>
                <p>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            @if($item->problem()->count())
                                ...
                                <a class="btn btn--sm" href="{{route('ladders.topicwise.show' ,$item->id)}}">
                                    <span class="btn__text">
                                    @if(auth()->user()->topic->contains($item->id))
                                        Continue
                                    @else
                                        Start
                                    @endif
