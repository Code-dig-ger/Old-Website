@extends('layouts.app')
@section('title')
<title>Codedigger | {{$level->name}} Level Ladders Problems</title>
@endsection
    ...
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8">
                <div class="wrapper"><h1 style="font-family: 'Lobster', sans-serif; margin-bottom:0; font-size:4rem;" >{{$level->name}} Level Problems</h1>
                </div>
                <strong><p>
            ...
            <div class="card card-1 boxed boxed--sm ">
                ...
                <div class="card__body ">
                    <a class="btn btn--sm" href="{{route('ladders.general.show' ,$problem->generaltopic->id) }} ">
